...
export default function Page() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <section className="border-t border-ink/10 bg-ink text-background"><div className="mx-auto grid max-w-7xl gap-16 px-5 py-24 md:grid-cols-2 md:px-10 md:py-28"><div><p className="eyebrow text-lime"><span className="eyebrow-line bg-lime" />Details</p><h2 className="mt-7 font-serif text-5xl leading-none tracking-[-.04em] md:text-6xl">The details matter.</h2><p className="mt-7 max-w-md leading-8 text-background/60">The foundation behind the work: a B.Tech in Computer Science, a Power BI certification, and a habit of staying curious.</p></div><div className="grid grid-cols-2 gap-x-8 gap-y-10"><div><GraduationCap className="text-lime" /><p className="mt-4 font-mono text-[10px] uppercase tracking-widest text-background/45">Education</p><p className="mt-2 font-medium">B.Tech, Computer Science</p></div><div><Sparkles className="text-lime" /><p className="mt-4 font-mono text-[10px] uppercase tracking-widest text-background/45">Certification</p><p className="mt-2 font-medium">Microsoft Power BI</p></div><div><Quote className="text-lime" /><p className="mt-4 font-mono text-[10px] uppercase tracking-widest text-background/45">Languages</p><p className="mt-2 font-medium">English · Hindi</p></div><div><ChevronDown className="text-lime" /><p className="mt-4 font-mono text-[10px] uppercase tracking-widest text-background/45">Approach</p><p className="mt-2 font-medium">Learn. Build. Share.</p></div></div></div></section>
